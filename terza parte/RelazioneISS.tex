...
Nasce quindi l'esigenza di definire una meta-modellazione di concetti che permetta di costruire e sviluppare delle regole e delle teorie applicabili a problematiche simili. Il passo successivo prevede la definizione di un \textbf{linguaggio custom}, in questo caso \textbf{domain specific}, che consenta una produzione di codice automatizzata e che permetta di abbattere i costi realizzativi legati alle soluzioni identificate ed inoltre permette di passare automaticamente da una modellazione dichiarativa del funzionamento del sistema a codice eseguibile favorendo una veloce prototipazione.\\
Avendo definito i concetti necessari all'interno dell'infrastruttura, della quale ci siamo avvalsi per riuscire a risolvere il problema proposto, si vogliono formalizzare questi concetti che rappresentano il meta-modellodi partenza. Per la definizione di un linguaggio custom ci si avvale della tecnlogia \textbf{Xtext} la quale ci permette di abbattere i tempi realizzativi da diversi mesi a pochi giorni. Xtext è una tecnologia open source che permette di generare il \textbf{parser}, il \textbf{lexer}, un \textbf{editor guidato della grammatica} oltre ad altre fuzionalità.
\\
\newline
\\
\begin{tabular}{ c }
	\hline	
	\includegraphics[scale = 0.6]{img/Xtext_gen.jpg}\\
	\hline
...
\begin{tabular}{ c }
	\hline	
	\includegraphics[scale = 0.6]{img/xtext.jpg}\\
	\hline
