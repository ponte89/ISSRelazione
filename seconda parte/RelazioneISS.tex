...
Avendo definto i requisiti nella prima relazione\footnote{Ingegneria dei Sistemi Software A differential drive Robot Prima Parte}, si specificano in manierea più approfondita delle aree che non erano state identificate:
\begin{itemize}
...
Un piano a questo livello può essere indetificato da un nome e composto da una serie di azioni che dovranno essere performate dal robot.
...
Azione che prevede una esecuzione con tipologia asincrona ovvero all'interno del proprio piano, una azione asincrona prevede la possibilità di essere interrotta alla ricezione di una nuova azione o di un comando halt proveniente dalla console.
